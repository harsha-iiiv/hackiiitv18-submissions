            ...
            <div class="row row_space">
              ...
              <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                        ...
                        <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group ">
                                <input  type="text" class="form-control"  placeholder="City" id="" list="cities"  name="city" required = "true">
                                                                
                                  <datalist id="cities">
                                    <option value="Ahmedabad-Gandhinagar">
                            ...
                            <center><a href="tq.php"><button type="submit" name="submit" class="btn  btn-success">Checkout</button></a></center>
                        </form>
                    </div>
